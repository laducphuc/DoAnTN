...
<title> Bài viết chưa duyệt</title>
<link rel="stylesheet"
					...
					<div class="col-lg-12 divMain" style="height: auto;">
						<div class="col-lg-12">
							<h4 style="font-size: 30px;text-align: center;">
								<i class="fa fa-users"></i> Bài Viết Chưa Duyệt
							</h4>
						</div>
						<div class="col-lg-12" style="border-bottom: 1px solid blue;">
							<h4>
								<i class="fa fa-list"></i> Danh sách các bài viết chưa từ chối
								hoặc chưa xem (
				...
				<div class="col-lg-3" style="height: auto; padding-right: 0px;">
					<div class="col-lg-12 danhMuc"
						...
						<div class="col-lg-12" style="padding-top: 20px;">
								<div class="col-lg-12 ">
							<label style="text-align: center;"><span class="glyphicon glyphicon-book"></span>  Quản Lý Bài Dịch</label>
						</div>
						<div class="col-lg-12">
