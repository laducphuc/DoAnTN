						...
						<html:form styleClass="form-horizontal" action="/tao-cau-hoi"
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<font color="red"><html:errors property="saiPhuongAn1" /></font>
									<html:file property="hinhanhPA1" styleId="hinhanhPA1"
										accept="image/*"></html:file>
									<font color="red"><html:errors property="saiHinhAnh1" /></font>
									<font color="red"><html:errors property="saiDinhDangHA1" /></font>
								</div>
								<label class="control-label col-sm-1" for="email"><font
									color="red">*</font></label>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<html:text styleId="pan2" property="phuongAn2"
										styleClass="form-control"></html:text>
									<font color="red"><html:errors property="saiPhuongAn2" /></font>
									<html:file property="hinhanhPA2" styleId="hinhanhPA2"
										accept="image/*"></html:file>
									<font color="red"><html:errors property="saiHinhAnh2" /></font>
									<font color="red"><html:errors property="saiDinhDangHA2" /></font>
								</div>
								<label class="control-label col-sm-1" for="email"><font
									color="red">*</font></label>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<html:text styleId="pan3" property="phuongAn3"
										styleClass="form-control"></html:text>
									<font color="red"><html:errors property="saiPhuongAn3" /></font>
									<html:file property="hinhanhPA3" styleId="hinhanhPA3"
										accept="image/*"></html:file>
									<font color="red"><html:errors property="saiHinhAnh3" /></font>
									<font color="red"><html:errors property="saiDinhDangHA3" /></font>
								</div>
								<label class="control-label col-sm-1" for="email"><font
									color="red">*</font></label>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<html:text styleId="pan4" property="phuongAn4"
										styleClass="form-control"></html:text>
									<font color="red"><html:errors property="saiPhuongAn4" /></font>
									<html:file property="hinhanhPA4" styleId="hinhanhPA4"
										accept="image/*"></html:file>
									<font color="red"><html:errors property="saiHinhAnh4" /></font>
									<font color="red"><html:errors property="saiDinhDangHA4" /></font>
								</div>
								<label class="control-label col-sm-1" for="email"><font
									color="red">*</font></label>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<html:text styleId="pan5" property="phuongAn5"
										styleClass="form-control"></html:text>
									<font color="red"><html:errors property="saiPhuongAn5" /></font>
									<html:file property="hinhanhPA5" styleId="hinhanhPA5"
										accept="image/*"></html:file>
									<font color="red"><html:errors property="saiHinhAnh5" /></font>
									<font color="red"><html:errors property="saiDinhDangHA5" /></font>
								</div>
								<label class="control-label col-sm-1" for="email"><font
									color="red">*</font></label>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-2" for="pwd">Đáp án:</label>
								<div class="col-sm-6">
							...
							<div class="form-group">
								<label class="control-label col-sm-2" for="pwd">Chọn cấp
									độ:</label>
								<div class="col-sm-6">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<html:submit styleClass="btn btn-default" property="btnSubmit"
