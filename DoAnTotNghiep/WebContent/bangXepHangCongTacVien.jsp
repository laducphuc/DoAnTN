...
<title>Bảng xếp hạng cộng tác viên</title>
<link rel="stylesheet"
					...
					<div class="col-lg-12 divMain"
						...
						<div class="col-lg-12">
							<h4 style="font-size: 30px; text-align: center;">
								<i class="fa fa-users"></i> Bảng xếp hạng cộng tác viên
							</h4>
						</div>


						<html:form action="/bang-xep-hang-cong-tac-vien" method="get">
						</html:form>

						<div class="col-lg-12" style="border-bottom: 1px solid blue;">
							<h4>
								<i class="fa fa-list"></i> Danh sách cộng tác viên
							</h4>
						</div>
						<div class="col-lg-12 thumbnail" style="min-height: 500px">
							<table class="table table-striped"
								...
								<tbody id="showtable">
									<logic:iterate name="thongKeForm" property="danhSachThanhVien"
										id="thanhVien">
										<tr>
											...
											<td><bean:write name="thanhVien" property="soSao" /></td>
