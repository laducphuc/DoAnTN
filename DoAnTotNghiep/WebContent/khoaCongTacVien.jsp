...
<title>Trang Admin- Khóa cộng tác viên</title>
<link rel="stylesheet"
						...
						<div class="col-lg-8">
							<div class="col-lg-12">
								<h4
									...
									<i class="fa fa-users"></i> Khóa cộng tác viên
								</h4>
							</div>
							...
							<html:form
								...
								<div class="row form-group">
									<label class="control-label col-sm-12"
										style="text-align: left;"><i class="fa fa-map-marker"></i>Địa
										chỉ:</label>
									<div class="col-sm-12">
								...
								<div class="row form-group">
									<label class="control-label col-sm-12"
										style="text-align: left;"><i class="fa fa-globe"></i>Quốc
										tịch:</label>
									<div class="col-sm-12">
								...
								<div class="row form-group">
									<label class="control-label col-sm-12"
										style="text-align: left;"><i class="fa fa-language"></i>Ngôn
										ngữ:</label>
									<div class="col-sm-12">
								...
								<div class="row form-group">
									<label class="control-label col-sm-12"
										style="text-align: left;"><i class="fa fa-phone"></i>Số
										điện thoại:</label>
									<div class="col-sm-12">
								...
								<div class="row form-group">
									<label class="control-label col-sm-12"
										style="text-align: left;"><i class="fa fa-envelope-o"></i>Email:</label>
									<div class="col-sm-12">
								...
								<div class="row form-group">
									<label class="control-label col-sm-12"
										style="text-align: left;"><i class="fa fa-user"></i>Tên
										đăng nhập:</label>
									<div class="col-sm-12">
								...
								<div class="row form-group">
									<label class="control-label col-sm-12"
										style="text-align: left;"><i class="fa fa-star-o"></i>Số
										sao:</label>
									<div class="col-sm-12">
								...
								<div class="row form-group">
									<label class="control-label col-sm-12"
										style="text-align: left;"><i class="fa fa-file-text-o"></i>Số
										bài đóng góp:</label>
									<div class="col-sm-12">
								...
								<div class="row form-group">
									<label class="control-label col-sm-12"
										style="text-align: left;"><i class="fa fa-key"></i>Số
										ngày bị khóa:</label>
									<div class="col-sm-12">
