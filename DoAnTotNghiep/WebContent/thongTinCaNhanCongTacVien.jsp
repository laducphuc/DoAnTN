						...
						<div class="col-lg-8">
							<div class="col-lg-12">
								<h4
									...
									<i class="fa fa-users"></i> Thông tin cá nhân cộng tác viên
								</h4>
							</div>
				...
				<div class="col-lg-3" style="height: auto; padding-right: 0px;">
					<div class="col-lg-12 danhMuc"
						...
						<div class="col-lg-12"
							...
							<h5
								style="color: black; text-align: center; padding: 10px; margin: 0px; font-size: 1.2em">
								Menu Cộng Tác Viên</h5>
							<ul>
								<li><html:link action="/tao-tu-vung.do"
										style="color: black;">
                 Tạo mới từ vựng</html:link></li>
								<li><html:link action="/tao-bai-hoc.do"
										style="color: black;">
               Tạo mới bài học</html:link></li>
								<li><html:link action="/tao-de-thi.do"
										style="color: black;">
               Tạo mới đề thi</html:link></li>
								<li><html:link action="/chon.do" style="color: black;">
               Tạo mới câu hỏi</html:link></li>
							</ul>
						</div>
