...
<title>Trang Admin - Cập nhật bài viết chưa dịch</title>
<link rel="stylesheet"
							...
							<html:form action="/cap-nhat-bai-viet?maBaiViet=${maBaiViet}"
								...
								<div class="col-lg-12">
									<html:textarea styleClass="form-control"
										...
										name="baiVietForm"></html:textarea>
								</div>
								...
								<div class="col-lg-12">
									<html:textarea styleClass="form-control"
										style="height: 120px; resize: none;" name="baiVietForm"
								...
								<logic:iterate id="noiDungViet" name="baiViet"
									...
									<div class="col-lg-12">
										<textarea id="noiDungDong<%=soCau%>" class="form-control"
											style="height: 100px; resize: none; border: 1px solid #EEEEEE;"><bean:write
								...
								<div class="col-lg-12">
									...
									<h5 class="title">
										Đánh Giá Chung Về Bài Dịch:<input id="rating-input"
											...
											data-size="xs" value="${saoSao}" data-rtl="false"
